...
//  • Returns penalty is "moderate": clearly felt, but complaints still bite
//    hardest and the base score still leads.
//
...
export const SCORE_CFG = {
  ...
  pRts: 2.5,            // points per (controllable RTS per 1,000) — moderate
  pConcession: 2.0,     // points per (concessions per 1,000)
  penaltyCap: 35,       // most a driver can lose from defects
  bonusMax: 5,          // most a driver can gain from proven high volume
