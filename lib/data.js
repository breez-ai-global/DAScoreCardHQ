...
// Composite ranking score: higher = better. Prefers the Breez composite's
// unclamped rankValue (set in lib/aggregate), then the displayed score, then a
// fallback built from DCR/POD minus defect signals.
export function rankScore(d) {
  if (d.rankValue !== null && d.rankValue !== undefined) return d.rankValue;
