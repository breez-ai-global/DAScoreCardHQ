...
export const TIPS = {
  ...
  Score: "Weekly blended score out of 100 (safety + quality + customer feedback). Breez scale: 98+ Platinum, 90+ Gold, 80+ Silver, 70+ Bronze, under 70 At Risk.",
  Tier: "The Breez tier, computed straight from the Overall Score: Platinum 98+, Gold 90+, Silver 80+, Bronze 70+, At Risk under 70. Hover a badge to see Amazon's (softer) official label when it differs.",
