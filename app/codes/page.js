...
const CODES = [
  ...
  ["Overall Standing", "Weekly Tier", "Each driver's weekly grade: Platinum (top), Gold, Silver, Bronze (bottom). It comes from the Overall Score, which blends safety + quality + customer feedback with different weights."],
  ["Overall Score", "Weekly Score out of 100", "The single blended number behind the tier. Roughly: 85+ = Platinum territory, 70–85 = Gold, below that = problem area."],
